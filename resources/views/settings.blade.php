                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/settings/password') }}">
                        ...
                        <div class="form-group {{ $errors->has('oldPassword') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control" id="oldPwd" name="oldPassword" placeholder="Enter password">
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('newPassword') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control" id="newPwd" name="newPassword" placeholder="Enter password">
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('newPassword_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control" id="pwdRep" name="newPassword_confirmation" placeholder="Repeat password">
                            </div>
                        </div>
