...
@section('content')
    <script type="text/javascript" src="bower_components/phaser/build/phaser.min.js"></script>
     ...
     <!--   <script type="text/javascript" src="main.js"></script>-->
        ...
        <script type="text/javascript" src="gameStates/functions.js"></script>
     ...
     <!--   <script type="text/javascript" src="deleted/menu.js"></script>-->
       ...
       <!-- <script type="text/javascript" src="deleted/play.js"></script>-->
        <script type="text/javascript" src="gameStates/win.js"></script>
        <script type="text/javascript" src="game.js"></script>
    <!--    <script type="text/javascript" src="gameStates/coins.js"></script>-->
